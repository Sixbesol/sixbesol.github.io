...
<div id="main-nav" class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color: #dedbdb;">
<div class="row" style="background: #103146;">
	<div class="col-md-4" style="text-align: center; padding: 4px;">
		<span class="fa fa-map-marker" style="color: grey;font-size: 25px;margin-right: 15px;"></span>
		<i style="color:white; font-size: 15px; font-family: initial;">Chateau Corbiac PécharmantChateau</i>
	</div>
	<div class="col-md-4" style="text-align: center; padding: 4px;">
		<span class="fa fa-clock-o" style="color: grey;font-size: 25px;margin-right: 15px;"></span>
		<i style="color:white; font-size: 15px; font-family: initial;">Open: Mon - Sat 08:00 - 19:00. Sunday CLOSED</i>
	</div>
	<div class="col-md-4" style="text-align: center; padding: 4px;">
		<span class="fa fa-phone" style="color: grey;font-size: 25px;margin-right: 15px;"></span>
		<i style="color:white; font-size: 15px; font-family: initial;">1-800-Corbiac-2171</i>
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#home">
                <img id="navlogo" src="images/img.gif" alt="microstore" width="122" height="45">
            </a>

        </div>
        <div class="collapse navbar-collapse">
            <ul id="navigation" class="nav navbar-nav navbar-right text-center">
                <li id="uk"><a href="#products" style="color: black;">Products</a></li>
                <li id="frech"><a href="#products" style="color: black;">des produits</a></li>
                <li><a href="#testimonial" style="color: black;">Reviews</a></li>
                <li><a href="#orderform" style="color: black;">Order</a></li>
                <li><a href="#about" style="color: black;">About Us</a></li>
                <li><a href="#contact" style="color: black;">Contact</a></li>
                <li class="fa fa-shopping-cart" style="font-size: 33px;margin-top: 13px;"></li>
            </ul>
        </div>
...
<section id="new-img" class=" padding-top-bottom" ng-controller="productsController">
    <div class="container">
        <div id="projects-container" class="row">

  
<img src="images/btl.png" style="margin-top: 50px;" class="img-responsive">
...
<section id="products" class=" padding-top-bottom col-md-12" ng-controller="productsController">
    <div class="container">
        ...
        <div id="projects-container" class="row">
            ...
            <article class="design product col-xs-12 col-sm-4 col-md-4  anima fade-up">
                <div class="img-box">
                    ...
                    <img class="img-responsive project-image" src="images/btl.png" alt="">
                </div>
                ...
                <div class="sr-only project-description"
                     data-images="images/btl.png,images/btl.png">
                    <p>
                        Produktinformation:
                    </p>
...
<section id="cta" class="col-md-12 padding-top-bottom color-bg light-typo" style="background: #103146;">
    <div class="container">
        <div class="row text-center">
            <div class="col-md-4 col-sm-4 news anima fade-up">
                <i class="fa fa-leaf" style="font-size: 65px;margin-top: 15px;"></i>
                <h3>eco-respons</h3>
            </div>
...
<section id="about" class="col-md-12 padding-top-bottom gray-bg">
    <div class="container">
        <div class="row">
            <div class="col-md-4 anima fadeInLeft">
                <header class="section-header cta-message">
                    <h2 class="anima fade-left d1">About The Business</h2>
                </header>
            </div>
            <div class="col-md-8 cta-message">
                <img src="images/abt.gif" class="col-md-2"><p  class="col-md-8 anima fade-right" style="font-size: 19px; font-family: inherit;">Château Corbiac Pécharmant, dans la même famille depuis 1587” / “Château Corbiac Pécharmant, propriété famaliale transmise au travers 17 générations successives</p>
            </div>
        </div>
    </div>
</section>
<section id="about" class="col-md-12 padding-top-bottom gray-bg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 cta-message anima fade-right">
                <img src="images/abr.gif" src="images/abr.gif" class="img-responsive">
            </div>
            <div class="col-md-6 cta-message anima fade-left d1">
                <p>Château Corbiac Pécharmant, dans la même famille depuis 1587” / “Château Corbiac Pécharmant, propriété famaliale transmise au travers 17 générations successives</p>
            </div>
    </div>
</section>
...
<section id="orderform" class="col-md-12 gray-bg padding-top-bottom" ng-controller="orderController">
    <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <table class="table" id="order-form-table">
                        ...
                        <tbody>
                        <tr>
                            <td class="vert-align">Millésimes</td>
                        ...
                        <tr>
                            ...
                            <td class="text-right vert-align">{{ vero.value * 200 | currency:"€" }}</td>
                        </tr>
                        <tr>
                            <td class="vert-align">Millésimes</td>
 ...
 <div class="col-md-4">
 	...
 	<input type="checkbox" value="payline">Pay by Payline<img src="images/download.png" class="img-responsive" style="width: 120px; margin: 20px; margin-bottom: 2px; margin-top: 2px;">
 	<input type="checkbox" value="cheque" style="margin: 15px 0 0 0;">    Cheque<img src="images/Dc06db14ce3e841d82eb08056a4d5b474.jpeg" class="img-responsive" style="width: 80px; margin: 20px; margin-bottom: 2px; margin-top: -2px;">
 </div>                             
 ...
 <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input name="address1" placeholder="Address 1" class="form-control" required="" type="text">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input name="zip" placeholder="Post Code" class="form-control" required="" type="text">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input name="state" placeholder="State" class="form-control" required="" type="text">
                    </div>
                    <div class="form-group">
            ...
            <input name="shipping" value="{{shipping = 3.99}}" hidden="text">

            <input class="hidden" name="items" id="pr-items" value="" type="text">
            <input name="subtotal" id="subtotal" value="{{subtotal | customNumber}}" type="hidden">
            <input name="shipping" id="shipping" value="{{shipping}}" type="hidden">
            <input name="total" id="total" value="{{total | customNumber}}" type="hidden">
                
                

                <div class="center-block" style="float: none; position:inherit; background-color: transparent">
                    <table class="table">
                        <thead>
                        <tr>
                        ...
                        <tr>
                            <td>Shipping cost:</td>
                            <td><img src="images/1.png" style="margin: 3px;"><img src="images/2.png" style="margin: 3px;"><img src="images/3.png" style="margin: 3px;"></td>
                      ...
                      <input type="checkbox"> Verify Your Age Above 18
                        
                        <button class="btn btn-block" style="text-align: center; margin-top: 10px; background-color: grey; color: black;">Select Payment Method</button>
                    </div>
...
<section id="contact" style="background-color: rgb(224, 224, 224);" class=" col-md-12 padding-top-bottom">
    <div class="container">
...
<footer id="main-footer" class="col-md-12 dark-bg light-typo" style="background: bl#000000;">
    <div class="container">
        <p class="pull-left copyright">
           legal information copyright (CNIL registration number ; information on alcohol abuse ; terms and conditions; c corbiac.com
        </p>
    </div>
</footer>

<div class="col-md-12 modal fade text-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
function myFunction() {
	...
	if('france' === lang) {
		alert('hhhhhhh');
		$('#'+lang).addClass('ac-lag');
		$('#uk').attr('id', 'de-lag');
	} else if('uk' === lang) {
		alert('jdsjsds');
		$('#'+lang).addClass('ac-lag');
		$('#frech').attr('id', 'de-lag');
	}	
