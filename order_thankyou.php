...
$statement = $conn->prepare("SELECT * FROM $dbname.`order` WHERE hash=:x");
...
$shipping_address = json_decode($result['shipping_address'], true);
...
<head>
    ...
    <link rel="shortcut icon" href="img/ico/favicon.ico" sizes="60x60" type="image/png"/>
...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#2DAFF0" style="border-bottom: 0px solid gray;">
    <tr>
        <td></td>
        <td class="header container">
            ...
            <div class="content">
                <table bgcolor="">
                    <tr>
                        <td>
                            <a href="http://www.mini-e-store.tk/" title="Mini E Store" ><img
                                    src="img/navlogo-green.jpg" style="width:121px;height:auto;"></a>
                        </td>
                        <td align="right">
                            <h6 style="color:white;" class="collapse">Order Confirmed</h6>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="content">
                <table>
                    <tr>
                        <td>
                            <br>
                            <h3>Thank you <?php echo $shipping_address['recipient_name']; ?></h3>
                            ...
                            <h4>Your Order
                                <small><?php echo $created_at; ?> {Server Timezone}</small>
                            </h4>
                            ...
                            <!-- Totals -->
                            <h5><b>Subtotal:</b> <?php echo $payment_info['subtotal']; ?>€</h5>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table align="left" class="column">
                                            <tr>
                                                <td>
                                                    <p><b>Shipping: <?php echo $payment_info['shipping']; ?>€</b></p>
                                                </td>
                                            </tr>
                                        </table>
                                        <!-- /column 1 -->
                            ...
                            <!-- /Totals -->
                            <h4><b>Total: <?php echo $payment_info['total']; ?>€ </b></h4>
                            <!-- /Totals -->
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p class="">
                                            ...
                                            State: <?php echo isset($shipping_address['state']) ? $shipping_address['state'] : ""; ?><br>
                                            Postal Code: <?php echo $shipping_address['zip']; ?><br>
                                            Country: <a href="https://countrycode.org/<?php echo $shipping_address['addressCountry']; ?>"
                                                    target="_blank"><?php echo $shipping_address['addressCountry']; ?></a><br>
        ...
        <td class="container">
            ...
            <div class="content">
                <table>
                    <tr>
                        <td align="center">
                            <p style="color: white;"><a href="http://mini-e-store.tk"
                                                        style="color:white;font-weight: bold;">Mini E Store</a></p>
                            <p style="color: white;"><strong><a href="mailto:lorem@lorem.com" style="color:white;">lorem@example.com</a></strong>
                            </p>
                        </td>
                    </tr>
                </table>
